...
require(data.table)
myplots <- "G:/BioAtmo/zuazo-p/General/eclaire/Automatic system/OUTPUTS/drying_wetting/_all_fluxes/thresholds/C_reference"

input.folder <- "G:/BioAtmo/zuazo-p/General/eclaire/Automatic system/OUTPUTS/drying_wetting/C_IDASw/C_incubation_filtered_360_corrected"
flux <- paste0(input.folder, "/C_filtered360_corrected.dat")
flux <- fread(flux)
...
# check boxplots
myplot <- paste0(myplots, "/C_incubation_cv_boxplots_testTime.png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
par(cex.axis = 1.5, cex.lab = 1.5, cex.main = 2.5 )
...
# plot it
myplot <- paste0(myplots, "/C_incubation_cv_vs_CONC__air_flux.png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
par(cex.axis = 1.5, cex.lab = 1.5, cex.main = 2.5 )
...
dev.off()
# 
myplot <- paste0(myplots, "/C_incubation_cv_vs_CONC__cal2_air.png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
par(cex.axis = 1.5, cex.lab = 1.5, cex.main = 2.5 )
...
# check boxplots
myplot <- paste0(myplots, "/C_incubation_crg_boxplots_testTime.png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
par(cex.axis = 1.5, cex.lab = 1.5, cex.main = 2.5 )
...
# plot it
myplot <- paste0(myplots, "/C_incubation_crg_vs_CONC__air_flux.png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
par(cex.axis = 1.5, cex.lab = 1.5, cex.main = 2.5 )
...
dev.off()
# 
myplot <- paste0(myplots, "/C_incubation_crg_vs_CONC__cal2_air.png")
png(filename = myplot, width = 1920, height = 1200, units = "px")
par(cex.axis = 1.5, cex.lab = 1.5, cex.main = 2.5 )
